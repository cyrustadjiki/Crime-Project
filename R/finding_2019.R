...
# Managing Crime Data from NIBRS 2019
...
for (i in files){
  NIBRS_VICTIM <- read_csv(gsub(' ', '', paste("Crime_Data_2019/", i, "/NIBRS_VICTIM.csv")))
...
for (i in files){
  agencies <- read_csv(gsub(' ', '', paste("Crime_Data_2019/", i, "/agencies.csv")))
...
NIBRS_OFFENDER <- read_csv("Crime_Data_2019/AL/NIBRS_OFFENDER.csv")
...
for (i in files){
  NIBRS_OFFENDER <- read_csv(gsub(' ', '', paste("Crime_Data_2019/", i, "/NIBRS_OFFENDER.csv")))
...
NIBRS_OFFENSE <- read_csv("Crime_Data_2019/AL/NIBRS_OFFENSE.csv")
...
for (i in files){
  NIBRS_OFFENSE <- read_csv(gsub(' ', '', paste("Crime_Data_2019/", i, "/NIBRS_OFFENSE.csv")))
...
#VICTIM OFFENDER REL
# Read example file
NIBRS_VICTIM_OFFENDER_REL <- read_csv("Crime_data_2019/AL/NIBRS_VICTIM_OFFENDER_REL.csv")
...
for (i in files){
  NIBRS_VICTIM_OFFENDER_REL <- read_csv(gsub(' ', '', paste("Crime_Data_2019/", i, "/NIBRS_VICTIM_OFFENDER_REL.csv")))
