...
feols(partner_crime~at_home_low | pop_dens + HH_inc + tfHH_65_percent
              + clf_ue/clf + month + tfHH_18_percent , data = df),


feols(property_crime~at_home_low | pop_dens + HH_inc + tfHH_65_percent
              + clf_ue/clf + month + tfHH_18_percent , data = df),
...
feols(log(child_crime)~at_home_low | pop_dens + HH_inc + tfHH_65_percent
              + clf_ue/clf + month + tfHH_18_percent , data = df2020)
